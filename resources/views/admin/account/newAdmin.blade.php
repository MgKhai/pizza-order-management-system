    ...
    <div class="row">
        <div class="col-6 offset-3 card p-3 shadow-sm rounded">
            ...
            <div class=" d-flex justify-content-end">
                <a href="{{ route('account#adminListPage') }}" class=" btn bg-danger my-2 w-25 rounded shadow-sm text-white"> <i
            ...
            <form action="{{ route('account#createAdmin') }}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="confirmPassword" value="" class="form-control @error('confirmPassword')
                            is-invalid
                        @enderror "
