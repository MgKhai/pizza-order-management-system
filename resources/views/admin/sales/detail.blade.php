...
@section('content')
    <div class="container-fluid">
        <a class="text-primary" href="{{ route('admin#salesInfoPage') }}" class=" text-black m-3"> <i
                    ...
                    <table class="table table-hover shadow-sm " id="productTable">
                        ...
                        <tbody>
                            ...
                            @foreach ($groupOrder as $items)
                                <tr>
                                    <input type="hidden" name="" class="productId"
            ...
            $('#btn-order-reject').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        res.status == 'success' ? location.href = '/admin/sales/info' : '';
                    }
                });
            })
        })
